                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        ...
                                        <label>
                                            <?php echo "Descripcion: " . $_POST['description'] ?>
                                        </label>
                                    </div>
                                    <?php
                                        ...
                                        //integra el SDK de mercado pago - access token
                                        MercadoPago\SDK::setAccessToken('APP_USR-6317427424180639-042414-47e969706991d3a442922b0702a0da44-469485398');
                                        
                                        $preference = new MercadoPago\Preference();
                                        
                                        //limita los payment methods
                                        ...
                                        $preference->notification_url = "https://gisellemilano-mp-ecommerce-php.herokuapp.com/notification.php";
