                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <?php 
                                        ...
                                        $external_reference = array(
                                            'order_id' => "123456",
                                            'product_id' => "1234",
                                            'my_email' => "milanoregina8@gmail.com",
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="detail.php" method="get">
                                            ...
                                            <input type="hidden" name="description" value="Dispositivo móvil de Tienda e-commerce">
                                            <input type="hidden" name="product_id" value="<?php $external_reference['product_id'] ?>">
                                            <input type="hidden" name="order_id" value="<?php $external_reference['order_id'] ?>">
                                            <input type="hidden" name="my_email" value="<?php $external_reference['my_email'] ?>">
                                            <input type="hidden" name="integrator_id" value="<?php $external_reference['integrator_id'] ?>">
